...
export default function Signup() {
  ...
  // audience if present
  const audience =
    new URLSearchParams(location.search).get("audience") || "patient";
      ...
      <div className="container mx-auto py-12">
        <div className="mx-auto max-w-md">
          ...
          <div className="rounded-md bg-yellow-50 border-l-4 border-yellow-400 p-4 text-sm">
            Les praticiens ne peuvent pas créer leur compte directement. Pour
            postuler, veuillez remplir le formulaire de recrutement.
          </div>
          <div className="mt-4">
            <Link
    ...
    <div className="container mx-auto py-12">
      <div className="mx-auto max-w-md">
        <h2 className="text-2xl font-semibold mb-4">
          Créer un compte {audience === "practitioner" ? "(Praticien)" : ""}
        </h2>
