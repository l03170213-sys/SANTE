    ...
    <div className="container mx-auto py-12">
      <div className="mx-auto max-w-md">
        <h2 className="text-2xl font-semibold mb-4">
          Se connecter {audience === "practitioner" ? "(Praticien)" : ""}
        </h2>
        ...
        {audience === "practitioner" ? (
          <div className="mt-4 rounded-md bg-yellow-50 border-l-4 border-yellow-400 p-4 text-sm">
            ...
            <div className="mt-1 text-sm text-muted-foreground">
              Les comptes praticiens ne peuvent pas être créés directement. Pour
              postuler,{" "}
              <Link
              ...
              . Si votre dossier est accepté, un compte vous sera créé et vous
              recevrez un mot de passe provisoire par email.
            </div>
          </div>
        ) : (
          <div className="mt-4 flex items-center justify-between">
            <div>
              ...
              <Link
                to={`/inscription${audience ? `?audience=${audience}` : ""}`}
