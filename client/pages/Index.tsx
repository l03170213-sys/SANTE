        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 max-w-lg text-xs text-muted-foreground">
              *Selon votre situation et le praticien. Les frais non
              remboursables peuvent s'appliquer en fonction des services
              choisis.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-[320px] md:w-[420px]">
              {/* Back phone */}
              <div
                className="absolute -right-6 top-6 z-0 -rotate-6 rounded-3xl border bg-white p-0 shadow-lg md:-right-10 md:top-10 md:p-0"
              ...
              <div
                className="relative z-10 mx-auto rounded-3xl shadow-2xl overflow-hidden"
            ...
            <div className="flex items-center gap-4 px-6 py-6">
              <span className="inline-block h-6 w-8 overflow-hidden rounded-sm">
                ...
                >
                  ...
                  <rect y="1.33" width="3" height="0.66" fill="#EF4135" />
                </svg>
              </span>
              <div className="text-xs text-muted-foreground">
                Société de téléconsultation agréée par le Ministère de la Santé
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h3 className="text-lg font-semibold">
                Et si vous preniez soin de votre santé mentale ?
              </h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Des psy à votre écoute, même le soir et le week-end
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  Médecins Généralistes, Psychiatres et Psychologues
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="h-10 w-10 rounded-full bg-emerald-100 grid place-items-center">
                ...
                >
                  <path
                    d="M12 2v6M5 7h14M8 22h8a2 2 0 002-2v-5H6v5a2 2 0 002 2z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  Médecins Généralistes, Gynécologues, Pédiatres...
                </div>
              </div>
            </div>
            <div className="text-muted-foreground">
